...
export const COMMON_DISEASES: CommonDisease[] = [
  ...
  {
    id: 'migraine',
    name: { en: 'Migraine', hi: 'माइग्रेन', gu: 'માઇગ્રેન' },
    description: { en: 'Recurring headache often linked with sensitivity to light, sound, or nausea.', hi: 'बार-बार होने वाला सिरदर्द जो रोशनी, आवाज़ या मतली से जुड़ा हो सकता है।', gu: 'વારંવાર થતો માથાનો દુખાવો જે પ્રકાશ, અવાજ અથવા ઊબકાથી જોડાયેલો હોઈ શકે છે.' },
    symptoms: { en: ['Throbbing headache', 'Light sensitivity', 'Nausea'], hi: ['धड़कता सिरदर्द', 'रोशनी से परेशानी', 'जी मिचलाना'], gu: ['ધબકતો માથાનો દુખાવો', 'પ્રકાશથી તકલીફ', 'ઉબકા'] },
    fullData: {
      en: createStaticData('Migraine', 'Recurring headache with sensitivity and discomfort.', ['Rest in a dark room', 'Stay hydrated', 'Cold compress on forehead'], ['Savasana', 'Pranayama'], ['Deep breathing', 'Gentle neck stretches'], ['Light meals', 'Warm herbal tea'], 'en'),
      hi: createStaticData('माइग्रेन', 'बार-बार होने वाला सिरदर्द और संवेदनशीलता।', ['अंधेरे कमरे में आराम करें', 'पानी पिएं', 'माथे पर ठंडी पट्टी रखें'], ['शवासन', 'प्राणायाम'], ['गहरी सांस', 'हल्की गर्दन स्ट्रेच'], ['हल्का भोजन', 'हर्बल चाय'], 'hi'),
      gu: createStaticData('માઇગ્રેન', 'વારંવાર થતો માથાનો દુખાવો અને સંવેદનશીલતા.', ['અંધારા રૂમમાં આરામ કરો', 'પાણી પીવો', 'કપાળ પર ઠંડી પટ્ટી રાખો'], ['શવાસન', 'પ્રાણાયામ'], ['ઊંડા શ્વાસ', 'હળવી ગરદન સ્ટ્રેચ'], ['હળવું ભોજન', 'હર્બલ ચા'], 'gu')
    }
  },
  {
    id: 'acidity',
    name: { en: 'Acidity / Heartburn', hi: 'एसिडिटी / सीने में जलन', gu: 'એસિડિટી / છાતીમાં જલન' },
    description: { en: 'Burning discomfort in the chest or upper stomach caused by acid reflux.', hi: 'एसिड रिफ्लक्स के कारण छाती या ऊपरी पेट में जलन।', gu: 'એસિડ રિફ્લક્સને કારણે છાતી અથવા ઉપરના પેટમાં થતી જલન.' },
    symptoms: { en: ['Burning chest', 'Sour taste', 'Bloating'], hi: ['सीने में जलन', 'खट्टा स्वाद', 'पेट फूलना'], gu: ['છાતીમાં જલન', 'ખાટો સ્વાદ', 'પેટ ફૂલવું'] },
    fullData: {
      en: createStaticData('Acidity / Heartburn', 'Burning discomfort caused by acid reflux.', ['Sip cold milk or water', 'Avoid spicy food', 'Eat small meals'], ['Vajrasana'], ['Light walking after meals'], ['Banana', 'Plain khichdi', 'Oats'], 'en'),
      hi: createStaticData('एसिडिटी / सीने में जलन', 'एसिड रिफ्लक्स के कारण जलन।', ['ठंडा दूध या पानी पिएं', 'मसालेदार भोजन से बचें', 'थोड़ा-थोड़ा भोजन करें'], ['वज्रासन'], ['भोजन के बाद हल्की सैर'], ['केला', 'सादा खिचड़ी', 'ओट्स'], 'hi'),
      gu: createStaticData('એસિડિટી / છાતીમાં જલન', 'એસિડ રિફ્લક્સને કારણે જલન.', ['ઠંડું દૂધ અથવા પાણી પીવો', 'મસાલેદાર ખોરાક ટાળો', 'થોડી-થોડી વાર ખાઓ'], ['વજ્રાસન'], ['જમ્યા પછી હળવું ચાલવું'], ['કેળું', 'સાદી ખીચડી', 'ઓટ્સ'], 'gu')
    }
  },
  {
    id: 'allergy',
    name: { en: 'Seasonal Allergy', hi: 'मौसमी एलर्जी', gu: 'મોસમી એલર્જી' },
    description: { en: 'Allergic response to dust, pollen, or weather changes.', hi: 'धूल, परागकण या मौसम बदलने से होने वाली एलर्जी।', gu: 'ધૂળ, પરાગકણ અથવા હવામાન બદલાવથી થતી એલર્જી.' },
    symptoms: { en: ['Sneezing', 'Runny nose', 'Itchy throat'], hi: ['छींक', 'बहती नाक', 'गले में खुजली'], gu: ['છીંક', 'વહેતું નાક', 'ગળામાં ખંજવાળ'] },
    fullData: {
      en: createStaticData('Seasonal Allergy', 'Allergic response to environmental triggers.', ['Steam inhalation', 'Warm saline gargle', 'Keep windows closed during dust exposure'], ['Pranayama'], ['Breathing exercises'], ['Warm soups', 'Tulsi tea'], 'en'),
      hi: createStaticData('मौसमी एलर्जी', 'पर्यावरणीय कारणों से होने वाली एलर्जी।', ['भाप लें', 'गर्म नमक पानी के गरारे करें', 'धूल में खिड़कियां बंद रखें'], ['प्राणायाम'], ['श्वास अभ्यास'], ['गर्म सूप', 'तुलसी चाय'], 'hi'),
      gu: createStaticData('મોસમી એલર્જી', 'પર્યાવરણના કારણે થતી એલર્જી.', ['વરાળ લો', 'ગરમ મીઠાના પાણીના કોગળા કરો', 'ધૂળમાં બારીઓ બંધ રાખો'], ['પ્રાણાયામ'], ['શ્વાસ કસરતો'], ['ગરમ સૂપ', 'તુલસી ચા'], 'gu')
    }
  },
  {
    id: 'back_pain',
    name: { en: 'Back Pain', hi: 'पीठ दर्द', gu: 'પીઠનો દુખાવો' },
    description: { en: 'Muscular or posture-related pain in the lower or upper back.', hi: 'मांसपेशियों या गलत मुद्रा से जुड़ा पीठ का दर्द।', gu: 'સ્નાયુઓ અથવા ખોટી બેઠક-ઉભી સ્થિતિથી થતો પીઠનો દુખાવો.' },
    symptoms: { en: ['Stiff back', 'Muscle soreness', 'Pain while bending'], hi: ['पीठ में जकड़न', 'मांसपेशियों में दर्द', 'झुकने पर दर्द'], gu: ['પીઠમાં કડકાઈ', 'સ્નાયુમાં દુખાવો', 'વાંકા થતા દુખાવો'] },
    fullData: {
      en: createStaticData('Back Pain', 'Muscular or posture-related back discomfort.', ['Warm compress', 'Gentle stretching', 'Maintain posture support'], ['Savasana', 'Pavanamuktasana'], ['Neck rolls', 'Light walking'], ['Warm soups', 'Calcium rich foods'], 'en'),
      hi: createStaticData('पीठ दर्द', 'मांसपेशियों या मुद्रा से जुड़ी असुविधा।', ['गर्म सिकाई', 'हल्की स्ट्रेचिंग', 'सही मुद्रा रखें'], ['शवासन', 'पवनमुक्तासन'], ['गरदन रोटेशन', 'हल्की सैर'], ['गर्म सूप', 'कैल्शियम युक्त भोजन'], 'hi'),
      gu: createStaticData('પીઠનો દુખાવો', 'સ્નાયુઓ અથવા બેઠક સ્થિતિથી થતી અસુવિધા.', ['ગરમ સેંક', 'હળવી સ્ટ્રેચિંગ', 'સાચી સ્થિતિ રાખો'], ['શવાસન', 'પવનમુક્તાસન'], ['ગરદન રોલ્સ', 'હળવું ચાલવું'], ['ગરમ સૂપ', 'કેલ્શિયમ યુક્ત ખોરાક'], 'gu')
    }
  },
  {
    id: 'indigestion',
    name: { en: 'Indigestion', hi: 'अपच', gu: 'અપચો' },
    description: { en: 'Digestive discomfort after eating, often with fullness or gas.', hi: 'खाने के बाद होने वाली पाचन असुविधा, भारीपन या गैस के साथ।', gu: 'જમ્યા પછી થતી પાચનની અસુવિધા, ભારેપણું અથવા ગેસ સાથે.' },
    symptoms: { en: ['Bloating', 'Gas', 'Upper stomach discomfort'], hi: ['पेट फूलना', 'गैस', 'ऊपरी पेट में असुविधा'], gu: ['પેટ ફૂલવું', 'ગેસ', 'ઉપરના પેટમાં અસુવિધા'] },
    fullData: {
      en: createStaticData('Indigestion', 'Digestive discomfort after meals.', ['Fennel or ajwain water', 'Avoid overeating', 'Take warm water slowly'], ['Vajrasana', 'Pavanamuktasana'], ['Light walking after meals'], ['Khichdi', 'Curd rice', 'Boiled vegetables'], 'en'),
      hi: createStaticData('अपच', 'भोजन के बाद पाचन असुविधा।', ['सौंफ या अजवाइन का पानी', 'अधिक भोजन न करें', 'गुनगुना पानी धीरे-धीरे पिएं'], ['वज्रासन', 'पवनमुक्तासन'], ['भोजन के बाद हल्की सैर'], ['खिचड़ी', 'दही चावल', 'उबली सब्जियां'], 'hi'),
      gu: createStaticData('અપચો', 'ભોજન પછીની પાચન અસુવિધા.', ['વરીયાળી અથવા અજમાનો પાણી', 'વધારે ન ખાવો', 'ગુંગણું પાણી ધીમે ધીમે પીવો'], ['વજ્રાસન', 'પવનમુક્તાસન'], ['જમ્યા પછી હળવું ચાલવું'], ['ખીચડી', 'દહીં ભાત', 'ઉકાળેલી શાકભાજી'], 'gu')
    }
  }
];
