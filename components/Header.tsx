    ...
    >
        ...
        <div className="flex items-center gap-3 px-4 py-3 sm:px-5">
          ...
          <div className="ml-auto flex items-center gap-2 sm:gap-3">
            <div className="hidden lg:block">
              <div className="rounded-full border border-[#E2E8F0] bg-[#F8FAFC] p-1 shadow-sm">
                <LanguageSelector
                  current={lang}
      ...
      >
        <div className="flex h-full flex-col overflow-y-auto p-4 sm:p-6">
          <div className="mb-6 rounded-[1.75rem] border border-[#E2E8F0] bg-[#F8FAFC] p-4 shadow-sm">
            <p className="mb-4 text-[12px] font-bold uppercase tracking-[0.22em] text-[#64748B]">
              {ui.navLangLabel}
            </p>
